...
const styleSheet = exports.styleSheet = new StyleXSheet({
  ...
  rootTheme: {
    ...
    'wig-nav-channel-gradient': 'linear-gradient(90deg, rgba(0,0,0,0.0), rgba(0,0,0,0.02))',
  ...
  rootDarkTheme: {
    ...
    'media-pressed': 'rgba(68, 73, 80, 0.35)',
    'messenger-card-background': '#18191A',
    'messenger-reply-background': '#373e4a',
    ...
    negative: 'hsl(350, 87%, 55%)',
    'negative-background': 'hsl(350, 87%, 55%, 20%)',
    'new-notification-background': '#242526',
    'non-media-pressed': 'rgba(68, 73, 80, 0.15)',
    'non-media-pressed-on-dark': 'rgba(255, 255, 255, 0.3)',
    'notification-badge': '#e41e3f',
    ...
    'wig-black-alpha-05': 'rgba(0, 0, 0, 0.05)',
    'wig-black-alpha-10': 'rgba(0, 0, 0, 0.1)',
    'wig-page-background': '#18191A',
    'wig-input-background': '#18191A',
    'wig-selected-background': 'rgba(255, 255, 255, 0.15)',
    'wig-hovered-background': 'rgba(255, 255, 255, 0.05)',
    'wig-official-entity': '#00c882',
    'wig-iris-100': '#4326C4',
    'wig-mushroom-120': '#896674',
    'wig-divider': '#333333',
    'fds-www-wash': 'black',
    'wig-nav-background': '#18191A',
    'wig-nav-channel-gradient': 'linear-gradient(90deg, rgba(0,0,0, 0), rgba(0,0,0,.2))',
    'wig-chat-background': '#242526',
    'wig-contrast-background': '#242526',
    'wig-chat-bubble-sender': '#78797b',
    'wig-chat-bubble': '#3e3e3e',
    'wig-foreign-entity': '#FF5F50',
    'wig-chat-default-color': '#535453',
    'wig-channel-icon-default-background': '#535453',
    'wig-group-cover-default-background': '#3e3e3e',
    'wig-quick-chat-settings-shadow-start': 'rgba(0, 0, 0, 0.1)',
    'wig-quick-chat-settings-shadow-end': 'rgba(0, 0, 0, 0.3)',
    'wig-primary-iris-90': '#573bd3',
    'workplace-chart-background': '#4C4E50',
    'workplace-chart-foreground': '#305A90',
    'workplace-chart-caption': '#050505',
    'tasks-priority-unbreak': '#8036cc',
    'tasks-priority-high': '#f23232',
    'tasks-priority-mid': '#f88639',
    'tasks-priority-low': '#eec954',
